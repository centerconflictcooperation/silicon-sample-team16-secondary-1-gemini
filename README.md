# Silicon Sample Benchmark: Team 16 secondary 1

This repository contains team 16's Tier-3 **Gemini 3.1 Pro Preview** submission
to the [Silicon Sample Benchmark](https://janpfander.github.io/llm_predictions_megastudy/).
...
`predictions/team_16_T3_secondary-1_v1.csv` (208 intervention-outcome ATEs).
...
<https://centerconflictcooperation.github.io/silicon-sample-team16-secondary-1-gemini/>
